...
We would prefer to receive solutions in *Go*, *Python* and *Node.js*, as most team members are proficient in these languages. We are also open to review solutions written in *Java*, *Ruby*, or *Clojure*. We recommend you use the language you are the most comfortable with. Feel free to use your preferred framework, libraries, and tools.
